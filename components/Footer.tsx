...
export default function Footer() {
  return (
    <footer className="bg-navy border-t-[4px] border-gold text-white relative z-20 mb-20 md:mb-0">
      <div className="max-w-[1400px] mx-auto px-4 py-8 sm:px-6 sm:py-12 lg:px-16 lg:py-16">
      ...
      {/* Copyright Bar */}
      <div className="border-t border-gold/20 bg-navy-dark px-4 sm:px-6">
